var chat = app.controller('ChatController', ['$stateParams', 'socket', '$sanitize', '$ionicScrollDelegate', '$timeout', function($stateParams, socket, $sanitize, $ionicScrollDelegate, $timeout) {
    ...
    // function called when user hits the send button or presses enter while cursor is on the message line
    ...
    // Generate color fo the same username
    function getUsernameColor(username) {
        // Compute hash connected
        var hash = 7;
    ...
    function message_string(number_of_users) {
        return number_of_users === 1 ? "there's 1 participant" : "there are " + number_of_users + " participant"
    }
